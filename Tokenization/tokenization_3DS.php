...
$f_request['f_amount'] = (float)21.59; // use your own amount
...
// !! IMPORTANT!! OBTAIN PAYMENT TOKEN based on parent x_trans_id and f_order_number
$f_request['x_payment_token'] = 'token'; // use the token obtained in query_for_token.php
...
// plationline auth with token 3DS
$auth_response = $po->auth($f_request, 2); // parameter 1 - request content, 2 - f_action (request for token payments.)
