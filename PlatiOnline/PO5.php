...
class PO5
{
    ...
    private $url_sv_sale_token_xml 					= 'https://secure.plationline.ro/xml_validation/v5/f_message-sale-by-token.xsd'; 	// sale-by-token
    private $url_sv_sale_token_response_xml 		= 'https://secure.plationline.ro/xml_validation/po-auth-by-token-response.xsd'; 	// sale-by-token response
